...
<table width="100%" cellpadding="5" cellspacing="0">
        ...
        <tr>
          <td width="31%" rowspan="10" valign="top"><div align="center"><img src="image.php/1182012113927PM.jpg" alt="" width="91" height="138"/></div></td>
          <td width="69%"><strong>Book Title:</strong> Doctor Zhivago</td>
    </tr>
        <tr><td><strong>Desc:</strong> <p>First published in Italy in 1957 amid international controversy, Doctor Zhivago is the story of the life and loves of a poet/physician during the turmoil of the Russian Revolution. Taking his family from Moscow to what he hopes will be shelter in the Ural Mountains, Zhivago finds himself instead embroiled in the battle between the Whites and the Reds. Set against this backdrop of cruelty and strife is Zhivago's love for the tender and beautiful Lara, the very embodiment of the pain and chaos of those cataclysmic times. Pevear and Volokhonsky masterfully restore the spirit of Pasternak's original his style, rhythms, voicings, and tone in this beautiful translation of a classic of world literature.</p></td></tr>
        <tr><td><strong>Author Name:</strong> <a>Boris Pasternak</a></td></tr>
        <tr>
          <td> <strong>Reference Number:</strong>3768</td>
        </tr>
        <tr><td><strong>ISBN:</strong> 9780099448426</td></tr>
        
        <tr>
          <td><strong>Number of Pages: </strong>464</td>
        </tr>
        ...
        <tr>
          ...
          <input type="button" name="button2" id="button2" value="Register"   onclick="GoRegister(5562)"/>
          </td>
        </tr>
  </table>
